...
\begin{figure}[H]
	...
	\caption[Constituency VT Tree-GRU]{}
	\label{fig:cvtgru}
\end{figure}

\subsubsection{Dependency}
Each sentences are in dependency parse tree.
