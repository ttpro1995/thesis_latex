...
\subsection{Overview}
\subsubsection{Sentiment Analysis and its application}
...
To deal with this problem, Sentiment Analysis is the field of study that computationally analyze opinions, sentiments, evaluations, appraisals, attitudes, and emotions expressed~\cite{liu2012sentiment}.
By it definition, Sentiment Analysis is not only applicable to customer reviews, in near future, we may also find its application in management sciences, political science, economics, and social sciences as they are all largely affected by opinions~\cite{liu2012sentiment}. 
...
\subsubsection{Deep Learning in Sentiment Analysis}
