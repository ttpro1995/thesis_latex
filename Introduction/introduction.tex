...
\item The results of experiments support the idea that Glove Amazon captured some good\footnote{good for sentiment analysis task on movie reviews} features that does not exist or hardly be extracted in Glove Common Crawl.
Additionally, some good features that does not appear in Glove Amazon but only appear in Glove Common Crawl or when combining both Glove Amazon and Glove Common Crawl.
