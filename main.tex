...
\usepackage{pgfplots}
\usepackage{pdfpages} % put pdf into page
...
\tikzstyle{cir} = [circle, minimum width=1cm, minimum height=1cm, text centered, draw=black ]
...
% ========================================================================================= %
\newcommand{\tenSV}{Van~Duy~Vinh} % Dấu ~ là khoảng trắng không được tách (các chữ nối với nhau bằng dấu ~ sẽ nằm cùng 1 dòng
\newcommand{\mssv}{1351050}
\newcommand{\tenSVt}{Thai~Thien } % Dấu ~ là khoảng trắng không được tách (các chữ nối với nhau bằng dấu ~ sẽ nằm cùng 1 dòng
\newcommand{\mssvt}{1351040}
\newcommand{\tenKL}{Deep~learning for Sentence-level Sentiment~Analysis} % Chú ý dấu ~ trong tên khóa luận
\newcommand{\tenGVHD}{Dr. Nghiêm~Quốc~Minh}
...
% TODO: print this \includepdf[pages={1,2}]{pdfpages/commentof.pdf}
...
% \usepackage{pdfpages} % put pdf into page
% TODO: print this \includepdf[pages=-]{pdfpages/thesisproposal.pdf}
...
\include{Result_discussion/result_discussion}
