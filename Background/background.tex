...
In the late nineteenth century, neurons, more precisely, neural network have been known to be the main facility of information processing in biological systems. 
To mathematically modeling it, the field of Artificial Neural Network have been born in the mid twentieth century (McCulloch and Pitts, 1943; Widrow and Hoff, 1960; Rosenblatt, 1962; Rumelhart et al., 1986). 
Since then, the field have diverged, become a matter of engineering and serve the purpose of achieving good results in Machine Learning tasks. 
This chapter will help you to understand some basic artificial neural network architects.
We will start with the most basic one -- Multilayer Perceptron. 
Despite it simplicity, it is the basic to understand other more advance network architects.
\subsection{Architect}
Although largely inspired by biological neuron, we will present only it mathematical model for the sake of this thesis.

Given a input vector x, 
