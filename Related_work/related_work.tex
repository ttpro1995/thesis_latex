...
\begin{figure}[H]
	\centering	\includegraphics[scale=0.25]{figure/para-vec-1}
	\caption{Distributed Memory Model of Paragraph Vectors (PV-DM)\cite{ParagraphVec}}
	\label{fig:para-vec-1}
\end{figure}

\begin{figure}[H]
	\centering	\includegraphics[scale=0.25]{figure/para-vec-2}
	\caption{Distributed Bag of Words version of Paragraph Vector (PV-DBOW)\cite{ParagraphVec}}
	\label{fig:para-vec-2}
\end{figure}

\paragraph{Applying unsupervised training to improve sentiment analysis on Stanford Sentiment Treebank}
